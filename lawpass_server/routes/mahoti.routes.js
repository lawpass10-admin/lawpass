...
// דיון מהותי — the candidate's own sittings of a generated paper.
//
...
// See db/mahoti.js for why.
//
// The paper itself (the questions, the notebook, the review) is still served by
// the Next.js side; only the sitting is filed here.
...
const v = require("../validators/mahoti");
const c = require("../controllers/mahoti.controller");
